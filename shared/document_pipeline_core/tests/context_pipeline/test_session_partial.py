...
from document_pipeline_core.context_pipeline.document_directive_filter.lib import (
...
from document_pipeline_core.context_pipeline.span_pool import ContextSpanPools, FilteredDocumentSpans
...
def test_cluster_spans_failure_propagates_partial_run(
    ...
    monkeypatch.setattr(
        "document_pipeline_core.context_pipeline.session.filter_document_spans",
        _fake_filter,
    )
    monkeypatch.setattr(
        "document_pipeline_core.context_pipeline.session.run_document_directive_filter",
        _fake_directive_filter,
    )
    monkeypatch.setattr(
        "document_pipeline_core.context_pipeline.session.run_cluster_spans",
