...
def test_call_anthropic_omits_output_config_when_schema_has_one_of() -> None:
    ...
    with (
        ...
        patch("document_pipeline_core.common.providers._require_api_key", return_value="test-key"),
        patch(
            "document_pipeline_core.common.providers.provider_runtime_config",
            return_value=provider_runtime_config("anthropic"),
        ),
        patch("document_pipeline_core.common.providers._resolve_max_output_tokens", return_value=1024),
        patch(
