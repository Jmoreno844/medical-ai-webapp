...
from document_pipeline_core.classification.templates import ClassificationTemplate
...
def weigh_classification_request_context(
    ...
    *,
    ...
    if classification_uses_py_prompt(prompt_version):
        from document_pipeline_core.classification.prompts.classification_prompt_v001 import render_template_context
