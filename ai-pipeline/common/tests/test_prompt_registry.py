...
def test_load_py_prompt_module_filtering_v002() -> None:
    ...
    assert module.__name__ == "filtering.prompts.filtering_prompt_v001"


def test_load_py_prompt_module_clustering_v002() -> None:
    module = load_py_prompt_module("clustering", "v002")
    assert module.__name__ == "clustering.prompts.clustering_prompt_v001"
...
def test_load_py_prompt_module_clustering_repair_v002() -> None:
    ...
    assert module.__name__ == "clustering.prompts.clustering_repair_prompt_v001"
...
def test_load_py_prompt_module_context_classify_clusters_v002() -> None:
    ...
    assert module.__name__ == "context_pipeline.classify_clusters.prompts.classify_clusters_prompt_v001"


def test_load_py_prompt_module_context_filter_spans_v002() -> None:
    module = load_py_prompt_module("context_filter_spans", "v002")
    assert module.__name__ == "context_pipeline.filter_spans.prompts.filter_spans_prompt_v001"
...
def test_load_py_prompt_module_classification_v004() -> None:
    ...
    assert module.__name__ == "classification.prompts.classification_prompt_v001"
...
def test_load_py_prompt_module_context_cluster_spans_v002() -> None:
    ...
    assert module.__name__ == "context_pipeline.cluster_spans.prompts.cluster_spans_prompt_v001"
...
def test_load_py_prompt_module_context_section_adapter_v003() -> None:
    ...
    assert module.__name__ == "context_pipeline.section_adapter.prompts.adapter_prompt_v001"
