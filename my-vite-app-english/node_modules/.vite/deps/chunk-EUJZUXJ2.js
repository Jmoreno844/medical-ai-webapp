...
var isLanguageSupportedByPrism = (language) => {
  try {
    return language ? Prism2.languages.hasOwnProperty(language) : false;
  } catch (_unused) {
    return false;
  }
};
      ...
      if (line.length > 0) {
        ...
        if (firstOfLine2 !== null) {
          if (type === INDENT_CONTENT_COMMAND) {
            firstOfLine2.insertBefore($createTabNode());
          } else if ($isTabNode(firstOfLine2)) {
            firstOfLine2.remove();
          }
        }
      }
...
prismjs/prism.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-EUJZUXJ2.js.map
