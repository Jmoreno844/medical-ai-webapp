import {
  ...
  HeadingNode,
  QuoteNode
} from "./chunk-TIJLJNDI.js";
import {
  $createCodeNode,
  $isCodeNode,
  CodeNode
} from "./chunk-EUJZUXJ2.js";
import {
  $createLinkNode,
  $isLinkNode,
  LinkNode
} from "./chunk-3MYEOLBS.js";
import {
  $createListItemNode,
  $createListNode,
  $isListItemNode,
...
function findOutermostTextMatchTransformer(textNode_, textMatchTransformers) {
  ...
  for (const transformer of textMatchTransformers) {
    ...
    if (foundMatchStartIndex === void 0 || foundMatchEndIndex === void 0 || startIndex < foundMatchStartIndex && endIndex > foundMatchEndIndex) {
...
//# sourceMappingURL=chunk-HMFM5LDV.js.map
